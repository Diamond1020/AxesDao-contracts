...
abstract contract TimedCrowdsale is Crowdsale {
    ...
    /**
     * @dev set opening time of crowdsale.
     * @param opening Crowdsale closing time
     */
    function setOpeningTime(uint opening) external onlyOwner {
        openingTime = opening;
    }
    /**
     * @dev set closing time of crowdsale.
     * @param closing Crowdsale closing time
     */
    function setClosingTime(uint closing) external onlyOwner {
        closingTime = closing;
    }
    /**
...
contract WhitelistPresale is Crowdsale, TimedCrowdsale
{
    ...
    constructor(uint allocationCap_, uint hardCap_, address[] memory whitelist_, uint numerator_, uint denominator_, address subject_, address token_, uint openingTime, uint closingTime)
