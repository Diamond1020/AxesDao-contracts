...
contract sAXS is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sAXS", "sXYZ", 9) ERC20Permit() {
    ...
    /**
        @notice increases sXYZ supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sXYZ
